...
model_config = dict(
    ...
    apply_adapter_to_layers=[0,1,2,3,4,5,6],
    num_labels=16,
    class_weights=None,
    label2id={
        "throat-clearing": 0,
...
training_config=dict(
    output_model_name="nonverbal_vocalization_dataset_whisper_small_lora",
    experiment_dir="nonverbal_vocalization_dataset/whisper_small_lora",
)