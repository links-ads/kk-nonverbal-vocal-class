...
model_config = dict(
    ...
    finetune_method="embedding_prompt",
    num_labels=16,
    class_weights=None,
    label2id={
        "throat-clearing": 0,
...
training_config=dict(
    output_model_name="nonverbal_vocalization_dataset_whisper_small_embedding_prompt",
    experiment_dir="nonverbal_vocalization_dataset/whisper_small_embedding_prompt",
)