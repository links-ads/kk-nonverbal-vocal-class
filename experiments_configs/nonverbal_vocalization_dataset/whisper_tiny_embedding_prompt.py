...
training_config=dict(
    output_model_name="nonverbal_vocalization_dataset_whisper_tiny_embedding_prompt",
    experiment_dir="nonverbal_vocalization_dataset/whisper_tiny_embedding_prompt",
)