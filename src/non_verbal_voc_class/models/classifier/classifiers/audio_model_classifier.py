...
class AudioModelClassifier(nn.Module):
    def __init__(self, model_config, use_conv_output: Optional[bool] = True) -> None:
        ...
        self.model_seq = nn.Conv1d(self.model_config.hidden_size, self.model_config.classifier_proj_size, 1, padding=0)
        ...
        self.out_layer = nn.Linear(self.model_config.classifier_proj_size, self.model_config.num_labels)
