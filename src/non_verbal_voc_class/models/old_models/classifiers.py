...
class LinearDownstreamModel(nn.Module):
    def __init__(self,
                model_config,
                ):
        super().__init__()
        ...
        self.classifier = nn.Linear(self.model_config.classifier_proj_size, self.model_config.num_labels)
...
class NonLinearDownstreamModel(nn.Module):
    def __init__(self,
                model_config,
    ):
        super().__init__()
